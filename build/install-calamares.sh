...
for script in calamares-config-logger.sh grub-install-luks-wrapper.sh grub-install-safe-wrapper.sh grub-mkconfig-safe-wrapper.sh calamares-setup-encryption-nag.sh calamares-post-install-cleanup.sh calamares-setup-recovery-key.sh calamares-copy-recovery-key.sh; do
