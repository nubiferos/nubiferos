...
- **0.x.x** — Alpha/Beta (current): Feature development, installer stabilization, OTA infrastructure
- **1.0.0 "Nimbus"** — First stable release: All alpha blockers resolved, daily-driver ready

---

[Unreleased]: https://github.com/nubiferos/nubiferos/compare/v0.1.0...HEAD
