...
- [ ] 7. Implement basic Resource Viewer application
  - [ ] 7.1 Set up application framework
  ...
  - [ ] 7.2 Implement resource indexer
...
- [ ] 8. Implement installer system
  ...
  - [ ] 8.3 Integrate installer into ISO
    - Configure ISO to boot into Calamares installer
    - Add live mode option for trying before installing (with security limitations notice)
    - Configure secure boot support
    - _Requirements: 1.3, 11.4, 12.3_

- [ ] 9. Implement AI Assistant Framework
  - [ ] 9.1 Create AI Assistant service architecture
  ...
  - [ ] 9.3 Implement workspace permission system
  ...
  - [ ] 9.5 Implement local LLM support (Ollama)
  ...
  - [ ] 9.6 Implement cloud AI provider plugins
  ...
  - [ ] 9.7 Implement read-only mode and approval workflow
  ...
  - [ ] 9.9 Implement privacy controls
  ...
  - [ ] 9.10 Create systemd service definition
  ...
  - [ ] 9.11 Integrate AI into Resource Viewer
...
- [ ]* 11. Testing and validation
  ...
  - [ ]* 11.3 Test credential management
  ...
  - [ ]* 11.4 Test workspace management
